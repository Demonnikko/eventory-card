...
export function mountApp() {
  ...
  async function route() {
    ...
    // Мягкая смена экрана: короткий уход старого контента, затем вставка
    // нового. Без этого замена innerHTML читается как «моргание» —
    // страница будто перезагружается на каждый тап по табу.
